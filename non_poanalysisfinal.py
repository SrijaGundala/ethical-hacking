"""
Module for Non PO Payment Analysis

This module imports functions and components from various tabs (tab2 to tab6) for
analyzing non-PO payments. Each tab handles different aspects of the analysis.

Imports:
    - Functions and components from tab2, tab3, tab1, tab4, tab5, tab6.

Usage:
    This script sets up a Streamlit application for uploading Excel files containing
    non-PO payment data, performing various analyses using imported functions.

    Functions like `datatab1`, `display_dashboard`, `Special_exceptions`, `tab5`, and `tab6`
    are used within different tabs (`t1` to `t6`) to display specific analyses and interact
    with the user interface.

Example:
    python non_poanalysisfinal.py

Note:
    Ensure all required dependencies are installed (`pandas`, `streamlit`, etc.) before running.

"""

# Import statements for tab2 to tab6 are here
from tab2 import *
from tab3 import *
from tab1 import *
from tab4 import *
